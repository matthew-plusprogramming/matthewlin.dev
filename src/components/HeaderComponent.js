        ...
        <ul>
          ...
          <li>
            <Link
              to={routes.about}
              onClick={() =>
                updateNavLocation(routes.about, false, true, prevRoute)
              }
              ref={aboutLinkRef}
            >
              About
          ...
          <li>
            <Link
              ...
              onClick={() =>
                updateNavLocation(routes.testimonials, false, true, prevRoute)
              }
          ...
          <li>
            <Link
              to={routes.contact}
              onClick={() =>
                updateNavLocation(routes.contact, false, true, prevRoute)
              }
              ref={contactLinkRef}
            >
              Contact
